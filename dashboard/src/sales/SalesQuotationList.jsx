...
import { fetchSalesQuotations } from './salesClient'

export default function SalesQuotationList({ onOpen, refreshKey }) {
  ...
  const load = async () => {
    setLoading(true)
    setRows(await fetchSalesQuotations())
    setLoading(false)
  }
  ...
  return (
    <div className="sales-list">
      ...
      {!loading && filtered.length === 0 && (
        <p className="empty">No sales quotations yet — convert a confirmed Sales Enquiry to create one.</p>
      )}
